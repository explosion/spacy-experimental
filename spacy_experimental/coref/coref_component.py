...
class CoreferenceResolver(TrainablePipe):
    ...
    def _check_for_leftover_annotations(self, docs: List[Doc]):
        """Check a batch of docs for annotations that look like they were set
    ...
    def set_annotations(
        ...
        # Check if there are any clusters generated by a similar process.
        self._check_for_leftover_annotations(docs)
