...
def test_initialize_examples():
    nlp = Language()
    lemmatizer = nlp.add_pipe("exp_edit_tree_lemmatizer")
    train_examples = []
    for t in TRAIN_DATA:
...
def test_no_data():
    ...
    nlp = English()
    nlp.add_pipe("exp_edit_tree_lemmatizer")
...
def test_incomplete_data():
    ...
    assert losses["exp_edit_tree_lemmatizer"] < 0.00001
...
def test_overfitting_IO():
    ...
    nlp3 = English()
    nlp3.add_pipe("exp_edit_tree_lemmatizer")
...
def test_lemmatizer_label_data():
    ...
    nlp2 = English()
    lemmatizer2 = nlp2.add_pipe("exp_edit_tree_lemmatizer")
